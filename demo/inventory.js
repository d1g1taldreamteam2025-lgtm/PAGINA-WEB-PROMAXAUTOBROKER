/* ⚠️ ARCHIVO GENERADO — COPIA DEMO de assets/js/inventory.js
   Único cambio: los enlaces de detalle van a /demo/vehicle/?id=
   Si editas assets/js/inventory.js, REGENERA este archivo. */
/* =====================================================================
...
(function () {
  ...
  function wire() {
    ...
    function prefetchFromEvent(e) {
      ...
      var a = e.target.closest ? e.target.closest('a[href*="/demo/vehicle/?id="]') : null;
      if (!a) return;
