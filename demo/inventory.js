...
(function () {
  ...
  function card(c) {
    ...
    return '<article class="pmx-vcard">' +
      '<a href="/demo/vehicle/?id=' + c.id + '" style="text-decoration:none;color:inherit;display:contents">' +
      '<div class="pmx-vcard__img" style="background-image:url(\'' + c.image + '\');background-color:#11151c">' +
